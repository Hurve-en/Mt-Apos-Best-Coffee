    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-coffee-50 to-white flex items-center justify-center">
        <div className="text-center">
          ...
          <h1 className="text-4xl font-bold text-coffee-900 mb-4">No orders yet</h1>
          <p className="text-gray-600 mb-8">Start ordering your favorite Mt. Apo coffee!</p>
          <button
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-coffee-50 to-white py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="text-4xl font-bold text-coffee-900 mb-8">📦 My Orders</h1>
          ...
          {orders.map((order) => (
            <div key={order.id} className="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition">
              ...
              <div className="flex justify-between items-start mb-6 pb-6 border-b-2 border-coffee-100">
                <div>
                  <h3 className="text-lg font-bold text-coffee-900">Order #{order.id.slice(0, 8).toUpperCase()}</h3>
              ...
              <div className="mb-6 p-4 bg-coffee-50 rounded-lg">
                <h4 className="font-bold text-coffee-900 mb-2">📍 Delivery Address:</h4>
              ...
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-2xl font-bold text-coffee-700">₱{order.totalPrice.toFixed(2)}</p>
                </div>
